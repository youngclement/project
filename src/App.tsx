...
import { Wallet as WalletIcon, Shield, ShoppingCart } from 'lucide-react';
import WalletButton from './components/WalletButton';
import UserProfile from './components/UserProfile';
import { SpinShop } from './pages/SpinShop';
import { SolanaWalletProvider } from './components/SolanaWalletProvider';
import { useWallet } from './hooks/useWallet';
import './styles/solSpinPurchase.css';
      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
            ...
            {isAuthenticated && (
              <nav className="flex items-center gap-4">
                <button
                  ...
                  className={`px-3 py-2 rounded-md text-sm font-medium ${currentPage === 'home'
                ...
                <button
                  ...
                  className={`px-3 py-2 rounded-md text-sm font-medium flex items-center gap-2 ${currentPage === 'shop'
                    ? 'bg-indigo-100 text-indigo-700'
                    : 'text-gray-500 hover:text-gray-700'
                    }`}
                >
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          {isAuthenticated && walletAddress ? (
            currentPage === 'shop' ? <SpinShop /> : <UserProfile />
          ) : (
